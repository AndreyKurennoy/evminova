            ...
            $(add_button).click(function(e){ //on add input button click
                ...
                if(x < max_fields){ //max input box allowed
                    ...
                    $(wrapper).append('<div class="admin-certificate">                        <div class="img-preview">\n' +
                        ...
                        '<div><input class="alt-img form-control" type="text" name="alt[]"  value="" placeholder="Alt картинки">' +
                        '         <input class="alt-img form-control" type="text" name="description[]" placeholder="Мини-описание картинки">               <button style="display: block; margin-top: 5px;" class="btn btn-primary" type="button" data-img="prev_img_'+ x +'" data-id="input_'+ x +'" onclick="BrowseServer(this);">Выбрать</button><a href="#" class="remove_field">Удалить</a></div></div>'); //add input box
                }
