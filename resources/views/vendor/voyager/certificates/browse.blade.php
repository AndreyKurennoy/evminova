                    ...
                    <div class="col-md-8">
                        ...
                        <div class="input_fields_wrap">
                            ...
                            <div class="admin-certificate">
                                ...
                                <div>
                                    <input class="alt-img" type="text" name="alt[]" placeholder="Alt картинки" value="{{$photo->alt}}"></div>
                                    <input class="alt-description" type="text" name="description[]" placeholder="Мини-описание картинки" value="{{$photo->description}}">
                                <button type="button" data-img="prev_img_{{$loop->index}}" data-id="input_{{$loop->index}}" onclick="BrowseServer(this);">Выбрать</button></div>
                            </div>
                            @endforeach
                        </div>
            ...
            $(add_button).click(function(e){ //on add input button click
                ...
                if(x < max_fields){ //max input box allowed
                    ...
                    $(wrapper).append('<div class="admin-certificate">                        <div class="img-preview">\n' +
                        ...
                        '<input class="alt-img" type="text" name="description[]" placeholder="Мини-описание картинки" value=""></div>' +
                        '         <input type="text" name="alt[]">               <button type="button" data-img="prev_img_'+ x +'" data-id="input_'+ x +'" onclick="BrowseServer(this);">Выбрать</button><a href="#" class="remove_field">Удалить</a></div>'); //add input box
                }
