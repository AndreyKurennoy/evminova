        ...
        <form class="contact-form" id="question-form">
            ...
            <div class="row margin-top-30">
                <div class="column column-1-2 align-left">
                    <input type="hidden" name="_token" value="hXddo5ru3kCa3yj8bosQCSS2BU2xB7CiPFLGFq8u">
                    <input type="hidden" name="enroll" value="1">
                    <input type="button" id="question" name="submit_question" value="ЗАПИСАТЬСЯ" class="more active">
                </div>
            </div>
        </form>
    </div>
